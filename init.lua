            ...
            cmp.setup({
                ...
                mapping = {
                    ["<Tab>"] = cmp.mapping(function(fallback)
                        ...
                        elseif vim.snippet and
                            vim.snippet.active({direction = 1}) then
...
-- LSP Setup
require("lspconfig").clangd.setup({cmd = {"clangd", "--background-index"}})
...
vim.keymap.set("n", "<leader>v", function() vim.cmd("vsplit | enew") end,
               {desc = "Vertical split and open new buffer"})
